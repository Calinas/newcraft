<template>
    <div class="nav_bar">
        <router-link :to="{path: '/cityList'}" tag="a" class="nav_post"></router-link>
...
<style scoped lang="scss">
    .nav_bar {
        ...
        input {
            ...
            text-indent: 1.4rem;
            background: url(../assets/nav_seach.png) no-repeat left center;
        ...
        .nav_post {
            background-image: url(../assets/nav_post.png);
            margin-right: 14px;
            position: relative;
        }
        .nav_cart {
        ...
        .nav_message {
            background-image: url(../assets/nav_message.png);
        }
        .nav_personal {
            background-image: url(../assets/nav_personal.png);
        }
    }
</style>